...
// 제공해주신 Pixabay 이미지 주소로 업데이트
const animalData = {
    "강아지": {
        img: "https://cdn.pixabay.com/photo/2023/01/01/16/04/dog-7690250_1280.jpg",
        desc: "🐶 충성심 가득! 귀여움 한도 초과! 주인이 퇴근하면 꼬리 헬리콥터 가동하는 멍뭉이상이시네요. 당신의 친화력은 우주 최강!"
    },
    "고양이": {
        img: "https://cdn.pixabay.com/photo/2019/06/13/11/49/cat-4271424_1280.jpg",
        desc: "🐱 차도남/차도녀의 정석! 가끔은 개냥이처럼 굴지만, 기본적으로 세상을 내려다보는 도도한 고양이상이시네요. 츤데레 매력에 다들 쓰러집니다."
    },
    "낙타": {
        img: "https://cdn.pixabay.com/photo/2018/09/27/15/34/camel-3707342_1280.jpg",
        desc: "🐫 인내심 끝판왕! 사막에서도 꿋꿋이 살아남는 강인한 생명력과 듬직함을 가진 낙타상이시네요. 당신의 성실함은 모두가 인정합니다."
    },
    "양": {
        img: "https://cdn.pixabay.com/photo/2014/04/13/20/49/lamb-323320_1280.jpg",
        desc: "🐑 순수함 그 자체! 하얀 구름처럼 몽글몽글하고 착한 마음씨를 가진 양상이시네요. 평화주의자인 당신 주변엔 항상 사람이 모입니다."
    },
    "쥐": {
        img: "https://cdn.pixabay.com/photo/2017/01/06/19/22/mouse-1958632_1280.jpg",
        desc: "🐭 영리하고 부지런한 매력! 작은 체구지만 눈치가 빠르고 센스가 넘치는 쥐상이시네요. 어디서든 굶지 않을 똑똑한 생존 본능의 소유자!"
    },
    "돼지": {
        img: "https://cdn.pixabay.com/photo/2019/03/13/10/37/pig-4052670_1280.jpg",
        desc: "🐷 복을 부르는 얼굴! 둥글둥글하고 여유로운 성격으로 주변을 행복하게 만드는 돼지상이시네요. 당신과 함께라면 언제나 풍요롭습니다."
    },
    "토끼": {
        img: "https://cdn.pixabay.com/photo/2021/11/14/19/12/animal-6795499_1280.jpg",
